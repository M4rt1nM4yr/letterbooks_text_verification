# https://github.com/Lightning-AI/lightning/issues/10914#issuecomment-993769544
...
class EMA(pl.Callback):
    ...
    def __init__(self, decay: float = 0.99, ema_device: Optional[Union[torch.device, str]] = None, pin_memory=True):
        super().__init__()
        self.decay = decay
